...
namespace MaksBooks.DataAccess.Migrations
{
    ...
    [Migration("20231127193354_AddValidationToProduct")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MaksBooks.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MaksBooks.Models.Product", b =>
                {
                    b.HasOne("MaksBooks.Models.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MaksBooks.Models.CoverType", "CoverType")
                        .WithMany()
